  ...
  const values = [
    {
      ...
      title: "Excellence",
      description: "We strive for excellence in every aspect of our service, from the products we use to the results we deliver."
    },
    {
      icon: <Users className="h-8 w-8 text-dialin-gold" />,
      title: "Reliability",
      description: "Our clients can count on us to be punctual, consistent, and thorough every single time."
    },
    {
      icon: <Heart className="h-8 w-8 text-dialin-gold" />,
      title: "Integrity",
      description: "We operate with honesty, transparency, and respect in all our business dealings and client relationships."
    },
    {
      icon: <Clock className="h-8 w-8 text-dialin-gold" />,
      title: "Efficiency",
      description: "We value your time and work efficiently to minimize disruption while maximizing results."
    }
  ];
    ...
    <div className="pt-20">
      ...
      <section className="relative py-16 bg-dialin-brown">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold text-white mb-4 animate-fade-in">About Dial-In</h1>
          <p className="text-dialin-beige max-w-2xl mx-auto mb-8 animate-fade-in [animation-delay:300ms]">
            Learn about our story, our mission, and the team behind our exceptional cleaning services.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in">
              <h2 className="text-3xl font-bold text-dialin-brown mb-6">Our Story</h2>
              <p className="text-gray-600 mb-4">
                Dial-In Building Maintenance was established in 2023 with a simple mission: to provide exceptional cleaning services that truly make a difference in the environments where people live and work.
              </p>
              <p className="text-gray-600 mb-4">
                In just two years, we've grown from a humble beginning into a trusted cleaning and maintenance service provider, serving residential and commercial clients throughout the region. Our rapid growth is built on a foundation of quality work, attention to detail, and genuine care for our clients' needs.
              </p>
              <p className="text-gray-600 mb-6">
                From the very start, we've been dedicated to our core values of excellence, reliability, integrity, and efficiency. These principles continue to guide every decision we make and every service we provide.
              </p>
              <p className="text-gray-600 mb-6">
                Our team consists of experienced professionals who bring 5-7 years of expertise in the cleaning and maintenance industry. Their skills and dedication ensure that every project is completed with precision and care, exceeding client expectations every time.
              </p>
      ...
      <section className="py-16 bg-dialin-beige">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-dialin-brown mb-4">Our Core Values</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              These principles guide our approach to every job and relationship, ensuring we deliver the highest quality service.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm animate-scale-in" style={{ animationDelay: `${index * 150}ms` }}>
                <div className="mb-4">{value.icon}</div>
                <h3 className="text-xl font-bold text-dialin-brown mb-2">{value.title}</h3>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Our staff members are thoroughly vetted, trained, and experienced in all aspects of cleaning and maintenance.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <Check className="text-dialin-gold mr-3 mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-gray-300">We tailor our services to meet your specific needs, not the other way around. Your satisfaction is our priority.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <Check className="text-dialin-gold mr-3 mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-gray-300">We use high-quality, eco-friendly cleaning products that are effective yet safe for your space and the environment.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <Check className="text-dialin-gold mr-3 mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-gray-300">We show up on time, every time, and complete our work efficiently and thoroughly. You can count on us.</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="py-16 bg-dialin-gold">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white mb-8 max-w-2xl mx-auto animate-scale-in [animation-delay:200ms]">
            Contact us today to schedule a consultation or request a free quote for your cleaning and maintenance needs.
          </p>
