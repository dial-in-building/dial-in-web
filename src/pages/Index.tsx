...
const Index = () => {
  const services = [
    {
      ...
      description:
        "Comprehensive cleaning services tailored for commercial spaces and retail stores.",
    },
    {
      icon: (
        <svg
          ...
          strokeLinejoin="round"
        >
          <path d="M3 22v-8.5l9-9 9 9V22"></path>
          <path d="M9 22V12h6v10"></path>
        </svg>
      ),
      title: "Strata Cleaning",
      description:
        "Professional cleaning solutions designed for strata properties and shared spaces.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Expert cleaning services to refresh and restore your carpets to pristine condition.",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "Dial-In transformed our office space. Their attention to detail is unmatched, and the team is always professional and punctual.",
      author: "Sarah Johnson",
      position: "Office Manager, Tech Solutions Inc.",
    },
    {
      quote:
        "We've tried several cleaning services, but none compare to Dial-In. They're thorough, reliable, and genuinely care about their work.",
      author: "Michael Reynolds",
      position: "Property Manager, Oakwood Residences",
    },
    {
      quote:
        "The level of service Dial-In provides is exceptional. Our medical facility has never been cleaner or more sanitized.",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl text-white">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 animate-fade-in">
              Dial-in Scrub Inc Maintenance Services
            </h1>
            <p className="text-lg md:text-xl mb-8 animate-fade-in [animation-delay:300ms]">
              Keep your spaces immaculate with our comprehensive cleaning and
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in [animation-delay:600ms]">
              <Button
                asChild
                size="lg"
                className="bg-dialin-gold hover:bg-dialin-brown text-white"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="animate-slide-in">
              ...
              <p className="text-gray-700 mb-6">
                At Dial-in Scrub Inc Maintenance, we're committed to providing
                exceptional cleaning services that meet the unique needs of your
                space. With years of experience and a dedicated team of
                professionals, we ensure pristine results that exceed
                expectations.
              </p>
              <ul className="space-y-2 mb-6">
                {[
                  ...
                  <li key={index} className="flex items-start">
                    <Check
                      size={20}
                      className="text-dialin-gold mr-2 mt-1 flex-shrink-0"
                    />
                    <span>{item}</span>
                  </li>
                ))}
              ...
              <Button
                asChild
                className="bg-dialin-brown hover:bg-dialin-lightbrown text-white"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              ...
              all your building maintenance needs.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-dialin-beige max-w-2xl mx-auto">
              With our dedication to excellence and customer satisfaction, we
              provide more than just cleaning services.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-dialin-brown/30 p-6 rounded-lg sweep-animation animate-scale-in">
              <div className="text-dialin-gold mb-4">
                ...
                >
                  ...
                  <path d="M8 12h8"></path>
                  <path d="M11 15H9c-.6 0-1-.4-1-1v-4c0-.6.4-1 1-1h2"></path>
            ...
            <div className="bg-dialin-brown/30 p-6 rounded-lg sweep-animation animate-scale-in [animation-delay:150ms]">
              ...
              <p className="text-gray-300">
                ...
                consistent, superior cleaning results every time.
              </p>
            </div>
            <div className="bg-dialin-brown/30 p-6 rounded-lg sweep-animation animate-scale-in [animation-delay:300ms]">
              ...
              <p className="text-gray-300">
                We use environmentally responsible cleaning products and methods
                that are safe for people, pets, and the planet.
              </p>
            </div>
          </div>
        </div>
