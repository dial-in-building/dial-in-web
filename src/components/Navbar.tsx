    ...
    <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-white shadow-md py-2" : "bg-transparent py-4"}`}>
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-1">
          <Link to="/" className={`navbar-link ${isActive("/") ? "active-link" : ""}`}>Home</Link>
          <Link to="/services" className={`navbar-link ${isActive("/services") ? "active-link" : ""}`}>Services</Link>
          ...
          <Link to="/about" className={`navbar-link ${isActive("/about") ? "active-link" : ""}`}>About</Link>
          <Link to="/contact" className={`navbar-link ${isActive("/contact") ? "active-link" : ""}`}>Contact</Link>
      ...
      {isMenuOpen && (
        <nav className="md:hidden bg-white py-4 px-4 shadow-md animate-fade-in">
          <div className="flex flex-col space-y-3">
            <Link 
              to="/" 
              className={`py-2 px-4 rounded ${isActive("/") ? "bg-dialin-beige text-dialin-brown" : "text-dialin-brown"}`}
            ...
            <Link 
              to="/services" 
              className={`py-2 px-4 rounded ${isActive("/services") ? "bg-dialin-beige text-dialin-brown" : "text-dialin-brown"}`}
              onClick={() => setIsMenuOpen(false)}
            >
              Services
            </Link>
            ...
            <Link 
              to="/about" 
              className={`py-2 px-4 rounded ${isActive("/about") ? "bg-dialin-beige text-dialin-brown" : "text-dialin-brown"}`}
              onClick={() => setIsMenuOpen(false)}
            >
              About
            </Link>
            <Link 
              to="/contact" 
              className={`py-2 px-4 rounded ${isActive("/contact") ? "bg-dialin-beige text-dialin-brown" : "text-dialin-brown"}`}
              onClick={() => setIsMenuOpen(false)}
            >
              Contact
            </Link>
